...
class Database:
    ...
    async def delete_all(self, group_id: int):
        ...
        prev = await self.col.find_one({"_id": group_id})
        if prev:
            await self.kurinji_active(group_id)
            await self.kurinji_filters(group_id)
    ...
    async def kurinji_active(self, group_id: int):
        """
    ...
    async def kurinji_filters(self, group_id: int):
        """
